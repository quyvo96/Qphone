          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" action="<%=request.getContextPath()%>/auth/register" method="post">
                  ...
                  <div class="form-group">
                    <input type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password" name="repassword">
                  </div>
                  <div class="mb-4">
                  ...
                  <div class="text-center mt-4 font-weight-light"> Already have an account? <a href="<%=request.getContextPath()%> + /login.html" class="text-primary">Login</a>
                  </div>
                </form>
              </div>
            </div>
