                            ...
                            <div class="col-md-12">
                                <form role="form" method="post" enctype="multipart/form-data" id="form_song">
                                    <div class="form-group">
                                        <label class="form-check-label" for="name">Màu</label>
                                        <input type="text" id="color" value="" name="color" class="form-control form-control-lg" placeholder="Nhập"/>
                                    </div>
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" readonly="readonly"  id="idPhone" value="<%=idPhone %>" name="idPhone" class="form-control form-control-lg" />
                                    </div>
