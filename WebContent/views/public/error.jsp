...
<html lang="en">
  ...
  <body>
            ...
            <div class="col-lg-7 mx-auto text-white">
              ...
              <div class="row mt-5">
                <div class="col-12 text-center mt-xl-2">
                  <a class="text-white font-weight-medium" href="<%=request.getContextPath()%>/trang-chu.html">Trang Chủ</a>
                </div>
              </div>
              <div class="row mt-5">
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="<%=request.getContextPath()%>/resources/public/assets/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
