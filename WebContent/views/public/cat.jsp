      ...
      <div class="container-fluid " style="margin-top: 100px">
        ...
        <div >
          ...
          <div id="slideabc">
			...
			%>
			<div style="margin-top: 20px"><h3 style="color: blue;">Điện thoại <%=nameCat%></h3></div>
			<%
			        ...
			        <tr>
                        <%
								try{
                                	...
                                	for(int j = GlobalConstants.NUMBER_PER_PAGE*i; j < GlobalConstants.NUMBER_PER_PAGE + i*GlobalConstants.NUMBER_PER_PAGE; j++){
			...
			<div class="card-body" style="padding-left: 43%">
				<a href="<%=request.getContextPath()%>/cat?idpage=<%=idpage+1%>&idCat=<%=idCat%>">
