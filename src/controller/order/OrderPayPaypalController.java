...
public class OrderPayPaypalController extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public OrderPayPaypalController() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Order orderByPaypal = new Order(id_order,2,2);
		int addOrderCart = orderDAO.updateStatus(orderByPaypal);
